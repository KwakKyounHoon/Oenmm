 ...
 */
public class DonatingPlacesRequest extends AbstractRequest<NetWorkResultType<DonatingPlace[]>> {
    Request request;
    public DonatingPlacesRequest(Context context, int pageNo, int count){
